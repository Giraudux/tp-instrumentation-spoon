# TP Instrumentation Spoon

## Usage

```
$ mvn package
$ java -cp .:target/tpSpoon-1.0-SNAPSHOT-jar-with-dependencies.jar fr.univ.nantes.Spoon -i src/main/resources/example/src/main/java/example -o src/main/resources/example-instrumented/src/main/java/example -p fr.univ.nantes.processor.MethodCallCounterProcessor
